...
|Local Notifications|Show local notifications|[NuGet](https://www.nuget.org/packages/Xam.Plugins.Notifier/)|[GitHub](https://github.com/edsnider/Xamarin.Plugins)|[@EdSnider](http://www.twitter.com/EdSnider), [@OfficialKrystin](https://twitter.com/officialkrystin), & [@JamesMontemagno](http://www.twitter.com/JamesMontemagno)|
|Media|Take or pick photos and videos.|[NuGet](https://www.nuget.org/packages/Xam.Plugin.Media/)|[GitHub](https://github.com/jamesmontemagno/Xamarin.Plugins/tree/master/Media)|[@JamesMontemagno](http://www.twitter.com/jamesmontemagno)|
...
|Permissions|Easily check and request runtime permissions.|[NuGet](http://www.nuget.org/packages/Plugin.Permissions)|[GitHub](https://github.com/jamesmontemagno/Xamarin.Plugins/tree/master/Permissions)|[@JamesMontemagno](http://www.twitter.com/jamesmontemagno)|
...
|HighlightMarker|A simple-to-use highlight marker for search text highlighting|[NuGet](https://www.nuget.org/packages/HighlightMarker)|[GitHub](https://github.com/thomasgalliker/HighlightMarker)|[@thomasgalliker](https://ch.linkedin.com/in/thomasgalliker)|
...
|ObservableView|A collection representation for searching, filtering, grouping, sorting...|[NuGet](https://www.nuget.org/packages/ObservableView)|[GitHub](https://github.com/thomasgalliker/ObservableView)|[@thomasgalliker](https://ch.linkedin.com/in/thomasgalliker)||PlatformAdapter|Brings together platform-independent and platform-specific assemblies|[NuGet](https://www.nuget.org/packages/CrossPlatformAdapter/)|[GitHub](https://github.com/thomasgalliker/PlatformAdapter/)|[@thomasgalliker](https://ch.linkedin.com/in/thomasgalliker)||Portable Razor|Lightweight implemenation of ASP.NET MVC APIs for mobile.|[NuGet](https://www.nuget.org/packages/PortableRazor/)|[GitHub](https://github.com/xamarin/PortableRazor)|[@JosephHill](http://www.twitter.com/josephhill)|
