...
|WebView|Extend the WebView with Javascript evaluation, callbacks, navigation events, and more.|[NuGet](https://www.nuget.org/packages/Xam.Plugin.WebView)|[GitHub](https://github.com/SKLn-Rad/Xam.Plugin.Webview)|[@Skln-Rad](https://github.com/SKLn-Rad)|
