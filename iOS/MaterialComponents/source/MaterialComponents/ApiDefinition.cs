...
interface BottomAppBarColorThemer 
{
	...
	void ApplyColorScheme(ColorScheme colorScheme, BottomAppBarView bottomAppBarView);
...
interface CardsShapeThemer 
{
	...
	void ApplyShapeScheme(ShapeScheming shapeScheme, Card card);

    [Static]
    [Export("applyShapeScheme:toCardCell:")]
	void ApplyShapeScheme(ShapeScheming shapeScheme, CardCollectionCell cardCell);
}
...
[Category]
[BaseType(typeof(TabBar),Name="MDCTabBar_MDCTabBarDisplayDelegate")]
...
interface UIFont_MaterialScalable 
{
	...
	UIFont ScaledFontForTraitEnvironment(UITraitEnvironment traitEnvironment);
}
