...
namespace ChameleonFramework
{
    ...
    interface ChameleonColor
    {
        ...
        UIColor ColorWithRandomFlatColorExcludingColorsInArray(NSObject[] colors);

        // +(UIColor *)colorWithRandomColorInArray:(NSArray *)colors;
        [Static]
        [Export("colorWithRandomColorInArray:")]

        UIColor ColorWithRandomColorInArray(NSObject[] colors);
        ...
        UIColor ColorWithGradientStyle(UIGradientStyle gradientStyle, CGRect frame, NSObject[] colors);
    ...
    interface UIViewController_Chameleon
    {
        ...
        void SetThemeUsingPrimaryColor(UIColor primaryColor, ContentStyle contentStyle);
        ...
        void SetThemeUsingPrimaryColor(UIColor primaryColor, UIColor secondaryColor, ContentStyle contentStyle);
        ...
        void SetThemeUsingPrimaryColor(UIColor primaryColor, UIColor secondaryColor, string fontName, ContentStyle contentStyle);
    ...
    interface Chameleon
    {
        ...
        void SetGlobalTheme(UIColor primaryColor, UIContentStyle contentStyle);
        ...
        void SetGlobalTheme(UIColor primaryColor, UIColor secondaryColor, UIContentStyle contentStyle);
        ...
        void SetGlobalTheme(UIColor primaryColor, UIColor secondaryColor, string fontName, UIContentStyle contentStyle);
    }
