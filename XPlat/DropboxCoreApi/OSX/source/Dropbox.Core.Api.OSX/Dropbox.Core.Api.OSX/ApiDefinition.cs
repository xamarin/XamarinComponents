...
using ObjCRuntime;
using CoreGraphics;
using Dropbox.CoreApi.OSX.MPOAuth;
...
namespace Dropbox.CoreApi.OSX
{
	...
	interface DBSession
	{
		...
		// -(MPOAuthCredentialConcreteStore *)credentialStoreForUserId:(NSString *)userId;
		[Export("credentialStoreForUserId:")]
		CredentialConcreteStore CredentialStoreForUserId(string userId);
		...
		// @property (readonly, nonatomic) NSArray * userIds;
		[Export("userIds")]
		NSObject[] UserIds { get; }

		[Wrap("WeakDelegate")]
		SessionDelegate Delegate { get; set; }
...
namespace Dropbox.CoreApi.OSX.MPOAuth
{
	...
	interface OAuth : OAuthInternalClient
	{
		...
		IntPtr Constructor(NSDictionary inCredentials, NSUrl inURL);
		...
		IntPtr Constructor(NSDictionary inCredentials, NSUrl inAuthURL, NSUrl inBaseURL);
		...
		IntPtr Constructor(NSDictionary inCredentials, NSUrl inAuthURL, NSUrl inBaseURL, bool aFlag);
		...
		void PerformMethod(string inMethod, NSObject inTarget, Selector inAction);
		...
		void PerformMethod(string inMethod, NSUrl inURL, NSObject[] inParameters, NSObject inTarget, Selector inAction);
		...
		void PerformPOSTMethod(string inMethod, NSUrl inURL, NSObject[] inParameters, NSObject inTarget, Selector inAction);
		...
		void PerformURLRequest(NSUrlRequest inRequest, NSObject inTarget, Selector inAction);

		// -(NSData *)dataForMethod:(NSString *)inMethod;
		[Export("dataForMethod:")]
		NSData DataForMethod(string inMethod);

		// -(NSData *)dataForMethod:(NSString *)inMethod withParameters:(NSArray *)inParameters;
		[Export("dataForMethod:withParameters:")]
		NSData DataForMethod(string inMethod, NSObject[] inParameters);
		...
		NSData DataForURL(NSUrl inURL, string inMethod, NSObject[] inParameters);

		// -(id)credentialNamed:(NSString *)inCredentialName;
		[Export("credentialNamed:")]
		NSObject CredentialNamed(string inCredentialName);

		// -(void)setCredential:(id)inCredential withName:(NSString *)inName;
		[Export("setCredential:withName:")]
		void SetCredential(NSObject inCredential, string inName);
