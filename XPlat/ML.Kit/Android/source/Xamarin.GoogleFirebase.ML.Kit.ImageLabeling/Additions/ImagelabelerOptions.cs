...
namespace Xamarin.GoogleFirebase.ML.Kit.Vision.Label.Defaults
{

	// Metadata.xml XPath class reference: path="/api/package[@name='com.google.mlkit.vision.label.defaults']/class[@name='ImageLabelerOptions']"
	//[global::Android.Runtime.Register("com/google/mlkit/vision/label/defaults/ImageLabelerOptions", DoNotGenerateAcw = true)]
	public partial class ImageLabelerOptions //: global::Xamarin.GoogleFirebase.ML.Kit.Vision.Label.ImageLabelerOptionsBase
	{
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.mlkit.vision.label.defaults']/class[@name='ImageLabelerOptions.Builder']/method[@name='build' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.mlkit.vision.label.defaults']/class[@name='ImageLabelerOptions.Builder']/method[@name='setConfidenceThreshold' and count(parameter)=1 and parameter[1][@type='float']]"
