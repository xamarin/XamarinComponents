...
namespace MoshiSample
{
    [Activity(Label = "MoshiSample", MainLauncher = true, Icon = "@drawable/icon", Theme = "@style/Theme.AppCompat")]
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            download.Click += async delegate
            {
                ...
                var moshi = new Square.Moshi.Moshi.Builder().Build();
                var jsonAdapter = moshi.adapter(typeof(List<Contributor>));

                List<Contributor> contributors = jsonAdapter.fromJson(body);
