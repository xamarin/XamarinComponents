...
{
	public class ScrollingSearchExampleFragment : BaseExampleFragment
	{
		public const int FIND_SUGGESTION_SIMULATED_DELAY = 250;
		...
		{
			return inflater.Inflate(Resource.Layout.fragment_scrolling_search_example, container, false);
		}
		...
		private void SetupSearchBar()
		{
			...
			mSearchView.SuggestionClicked += async (sender, e) =>
			{
				...
				var results = await DataHelper.FindColorsAsync(Activity, colorSuggestion.GetBody());
		...
		public override bool OnActivityBackPress()
		{
			...
			// state and it makes sense to call base.OnBackPressed() and close the activity
