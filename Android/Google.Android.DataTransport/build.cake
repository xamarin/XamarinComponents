...
Dictionary<string, string> URLS_ARTIFACT_FILES= new Dictionary<string, string>()
{
	...
	{
		$"https://maven.google.com//com/google/android/datatransport/transport-backend-cct/2.2.1/transport-backend-cct-2.2.1.aar",
		$"./externals/android/transport-backend-cct-2.2.1.aar"
	},
	{
		$"https://maven.google.com//com/google/android/datatransport/transport-runtime/2.2.1/transport-runtime-2.2.1.aar",
		$"./externals/android/transport-runtime-2.2.1.aar"
	},
};
