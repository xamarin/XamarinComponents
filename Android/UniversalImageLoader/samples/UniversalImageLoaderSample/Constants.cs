namespace UniversalImageLoaderSample
{
    public static class Constants
    {
        public static readonly string[] Images = new string[]
        {
			...
			"file:///sdcard/Universal Image Loader @#&=+-_.,!()~'%.png", // Image from SD card with encoded symbols
			"assets://Living Things @#&=+-_.,!()~'%.jpg", // Image from assets
			"drawable://" + Resource.Drawable.icon, // Image from drawables
        ...
        public class Extra
        {
            public const string FragmentIndex = "com.example.universalimageloader.FRAGMENT_INDEX";
            public const string ImagePosition = "com.example.universalimageloader.IMAGE_POSITION";
        }
    }
}
