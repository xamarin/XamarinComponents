...
var fetchers = new VersionFetcher[] {
    ...
    new MavenCentral ("Better Pickers", "1.6.0.2", "com/doomonafireball/betterpickers/library", OWNER_CA1),
    ...
    new MavenCentral ("GoogleGson", "2.8.5", "com/google/code/gson/gson", OWNER_SA1),
    ...
    new MavenCentral ("Universal Image Loader", "1.9.5.1", "com/nostra13/universalimageloader/universal-image-loader", OWNER_SA1),
    ...
    new MavenCentral ("AndroidEasingFunctions", "1.0.2.0", "com.daimajia.easing", OWNER_SA1),
    new MavenCentral ("AndroidViewAnimations", "1.1.3.0", "com.daimajia.androidanimation", OWNER_SA1),
    new Maven ("Blurring", "1.1.0", "https://github.com/500px/500px-android-blur/blob/master/releases/com/fivehundredpx/blurringview/maven-metadata.xml", OWNER_CA1),
    new MavenCentral ("DeviceYearClass", "1.0.0", "com.facebook.device.yearclass", OWNER_SA1),
    new MavenCentral ("Glide", "4.0", "com.github.bumptech.glide", OWNER_SA1),
    new MavenCentral ("GoogleZXing", "3.3.0", "com.google.zxing", OWNER_SA1),
    new MavenCentral ("Guava", "23.2.0", "com.google.guava", OWNER_SA1),
    new MavenCentral ("Jackson.Core", "2.7.4.1", "com.fasterxml.jackson.core", OWNER_SA1),
    ...
    new MavenCentral ("ShimmerLayout", "4.3.1", "io.supercharge", OWNER_SA1),
    new MavenCentral ("UrlImageViewHelper", "1.0.4.2", "com.koushikdutta.urlimageviewhelper", OWNER_SA1),
    new MavenCentral ("Bolts", "4.0.3", "com.parse.bolts", OWNER_SA1),
    ...
    new CocoaPods ("DACircularProgress", "2.3.1.0", "DACircularProgress", OWNER_SA1),
    new CocoaPods ("DZNEmptyDataSet", "1.7.3", "DZNEmptyDataSet", OWNER_SA1),
    new CocoaPods ("FXBlurView", "1.6.4.0", "FXBlurView", OWNER_SA1),
    new CocoaPods ("GPUImage", "0.1.7", "GPUImage", OWNER_SA1),
    new CocoaPods ("InAppSettingsKit", "2.6.0.1", "InAppSettingsKit", OWNER_SA1),
    new CocoaPods ("JDStatusBarNotification", "1.5.3.1", "JDStatusBarNotification", OWNER_SA1),
    ...
    new CocoaPods ("MWPhotoBrowser", "2.1.1.1", "MWPhotoBrowser", OWNER_SA1),
